                ...
                7 -> {
                    if (meals.isEmpty()) {
                        ...
                        if (totalCal == 0) {
                            ...
                            binding.breakfast7.layoutParams.height = breakfast.calories * 200 / totalCal
                            binding.lunch7.layoutParams.height = lunch.calories * 200 / totalCal
                            binding.dinner7.layoutParams.height = dinner.calories * 200 / totalCal
                            binding.other7.layoutParams.height = snacks.calories * 200 / totalCal
                        }
                        when (day.day) {
                            1 -> {
                                if (day.date < 10) {
                ...
                6 -> {
                    if (meals.isEmpty()) {
                        ...
                        if (totalCal == 0) {
                            ...
                            binding.breakfast6.layoutParams.height = breakfast.calories * 200 / totalCal
                            binding.lunch6.layoutParams.height = lunch.calories * 200 / totalCal
                            binding.dinner6.layoutParams.height = dinner.calories * 200 / totalCal
                            binding.other6.layoutParams.height = snacks.calories * 200 / totalCal
                        }
                        when (day.day) {
                            1 -> {
                                if (day.date < 10) {
                ...
                5 -> {
                    if (meals.isEmpty()) {
                        ...
                        if (totalCal == 0) {
                            ...
                            binding.breakfast5.layoutParams.height = breakfast.calories * 200 / totalCal
                            binding.lunch5.layoutParams.height = lunch.calories * 200 / totalCal
                            binding.dinner5.layoutParams.height = dinner.calories * 200 / totalCal
                            binding.other5.layoutParams.height = snacks.calories * 200 / totalCal
                        }
                        when (day.day) {
                            1 -> {
                                if (day.date < 10) {
                ...
                4 -> {
                    if (meals.isEmpty()) {
                        ...
                        if (totalCal == 0) {
                            ...
                            binding.breakfast4.layoutParams.height = breakfast.calories * 200 / totalCal
                            binding.lunch4.layoutParams.height = lunch.calories * 200 / totalCal
                            binding.dinner4.layoutParams.height = dinner.calories * 200 / totalCal
                            binding.other4.layoutParams.height = snacks.calories * 200 / totalCal
                        }
                        when (day.day) {
                            1 -> {
                                if (day.date < 10) {
                ...
                3 -> {
                    if (meals.isEmpty()) {
                        ...
                        if (totalCal == 0) {
                            ...
                            binding.breakfast3.layoutParams.height = breakfast.calories * 200 / totalCal
                            binding.lunch3.layoutParams.height = lunch.calories * 200 / totalCal
                            binding.dinner3.layoutParams.height = dinner.calories * 200 / totalCal
                            binding.other3.layoutParams.height = snacks.calories * 200 / totalCal
                        }
                        when (day.day) {
                            1 -> {
                                if (day.date < 10) {
                ...
                2 -> {
                    if (meals.isEmpty()) {
                        ...
                        if (totalCal == 0) {
                            ...
                            binding.breakfast2.layoutParams.height = breakfast.calories * 200 / totalCal
                            binding.lunch2.layoutParams.height = lunch.calories * 200 / totalCal
                            binding.dinner2.layoutParams.height = dinner.calories * 200 / totalCal
                            binding.other2.layoutParams.height = snacks.calories * 200 / totalCal
                        }
                        when (day.day) {
                            1 -> {
                                if (day.date < 10) {
                ...
                1 -> {
                    if (meals.isEmpty()) {
                        ...
                        if (totalCal == 0) {
                            ...
                            binding.breakfast1.layoutParams.height = breakfast.calories * 200 / totalCal
                            binding.lunch1.layoutParams.height = lunch.calories * 200 / totalCal
                            binding.dinner1.layoutParams.height = dinner.calories * 200 / totalCal
                            binding.other1.layoutParams.height = snacks.calories * 200 / totalCal
                        }
                        when (day.day) {
                            1 -> {
                                if (day.date < 10) {
